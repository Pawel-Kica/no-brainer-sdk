...
date: string;
    ...
    export class SdkClient {
        ...
        async create_critical_task({args, fields,  headers}:{args: CreateCriticalTaskArgs, fields:((keyof CriticalTask) | Partial<Record<keyof CriticalTask,any[]>>)[], headers?:HeadersInit}):Promise<CriticalTask>{ 
            if(!headers) headers = {};
            return this.gql_request(gql`
                ...
                `,args || {},headers,'create_critical_task')
                }

async update_critical_task({args, fields,  headers}:{args: UpdateCriticalTaskArgs, fields:((keyof CriticalTask) | Partial<Record<keyof CriticalTask,any[]>>)[], headers?:HeadersInit}):Promise<CriticalTask>{ 
            if(!headers) headers = {};
            return this.gql_request(gql`
                ...
                `,args || {},headers,'update_critical_task')
                }



        async user({ fields,  headers}:{ fields:((keyof User) | Partial<Record<keyof User,any[]>>)[], headers?:HeadersInit}):Promise<User>{ 
            if(!headers) headers = {};
            return this.gql_request(gql`
                query {
                    user
...
async user_power_list({args, fields,  headers}:{args: UserPowerListArgs, fields:((keyof PowerListResult) | Partial<Record<keyof PowerListResult,any[]>>)[], headers?:HeadersInit}):Promise<PowerListResult>{ 
            if(!headers) headers = {};
            return this.gql_request(gql`
                query($date: String!) {
